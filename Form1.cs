namespace PacMan
{
    public partial class Form1 : Form
    {
        ...
        private void SetUp()
        {
            ...
            // this.Text = walls.Count + "  " + coins.Count; // Test ob Coins und Walls richtig gezählt sind
            ...
            ghosts.Add(yellow);
            pink = new Ghost(this, Properties.Resources.pink, 820, 130);
            ghosts.Add(pink);
        }
        ...
        private void GameOver(string message)
        {
            ...
            GameTimer.Stop();
            ShowCoins();
            pacman.Location = new Point(483, 334);
